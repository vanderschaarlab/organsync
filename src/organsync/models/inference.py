...
class Inference_OrganSync(Inference):
    def __init__(self, model: OrganSync_Network) -> None:
...
class Inference_OrganITE(Inference):
    def __init__(self, model: OrganITE_Network) -> None:
...
class Inference_OrganITE_VAE(Inference):
    def __init__(self, model: OrganITE_Network_VAE) -> None:
        assert isinstance(
...
class Inference_ConfidentMatch(Inference):
    def __init__(self, model: ConfidentMatch) -> None:
...
class Inference_TransplantBenefit(Inference):
    def __init__(self, model: Tuple[UKELDModel, UKELDModel]) -> None:
